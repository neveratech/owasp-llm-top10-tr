...
> yayımlanan **OWASP Top 10 for LLM Applications 2026** belgesinin Türkçe çevirisini içerir.
> OWASP bu çeviriyi onaylamış veya incelemiş değildir; anlaşmazlık hâlinde esas metin
> İngilizce orijinaldir.

| | |
|---|---|
| **Orijinal belge** | [OWASP GenAI LLM Top 10 2026](https://genai.owasp.org/resource/owasp-genai-llm-top-10-2026/) (v1.0, 4 Ağustos 2026) |
...
CC BY-SA 4.0 gereği belirtilir: bu depo orijinal İngilizce belgenin Türkçeye çevirisidir.
İçerik eklenmemiş veya çıkarılmamıştır; yalnızca dil dönüştürülmüş, biçim PDF'ten
Markdown'a aktarılmıştır. Madde kimlikleri (LLM01–LLM10) ve İngilizce başlıklar resmî
olduğundan korunmuş, Türkçe karşılıkları yanlarında verilmiştir.
...
Orijinal eser: *OWASP Top 10 for Large Language Model Applications, Version 2026.*
OWASP GenAI Security Project, OWASP Foundation. DOI:
[10.5281/zenodo.22109015](https://doi.org/10.5281/zenodo.22109015). CC BY-SA 4.0.

Bu çeviri de aynı lisansla dağıtılır: paylaşabilir, uyarlayabilirsiniz — atıf vermek ve
aynı lisansı korumak koşuluyla.
